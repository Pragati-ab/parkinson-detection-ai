document
    ...
    .addEventListener("submit", async function (e) {
        ...
        const data = {
            ...
            MDVP_Shimmer: parseFloat(
                document.getElementById("MDVP_Shimmer").value
            ),

            voice_amplitude_instability: parseFloat(
                document.getElementById(
                    "voice_amplitude_instability"
                ).value
            ),

            MDVP_APQ: parseFloat(
                document.getElementById("MDVP_APQ").value
            ),

            MDVP_Flo_Hz: parseFloat(
                document.getElementById(
                    "MDVP_Flo_Hz"
                ).value
            ),

            Shimmer_APQ5: parseFloat(
                document.getElementById(
                    "Shimmer_APQ5"
                ).value
            ),
            ...
            Shimmer_DDA: parseFloat(
                document.getElementById(
                    "Shimmer_DDA"
                ).value
            ),

            Shimmer_APQ3: parseFloat(
                document.getElementById(
                    "Shimmer_APQ3"
                ).value
            ),
        ...
        try {
            ...
            // Healthy Result
                ...
                resultTitle.innerHTML =
                    "✅ No Strong Parkinson Indicators";
